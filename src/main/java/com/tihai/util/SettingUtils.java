/*
 * Copyright 2005-2013 tihai.net. All rights reserved.
 * Support: http://www.tihai.net
 * License: http://www.tihai.net/license
 */
...
import com.tihai.common.CommonAttributes;
import com.tihai.common.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File tihaiXmlFile = new ClassPathResource(CommonAttributes.SETTING_XML_PATH).getFile();
				Document document = new SAXReader().read(tihaiXmlFile);
				List<Element> elements = document.selectNodes("/tihai/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			try {
				...
				fileOutputStream = new FileOutputStream(tihaiXmlFile);
