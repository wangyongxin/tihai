...
import com.tihai.common.Order.Direction;
...
//			this.searchString = this.searchProperty + " like '%" + this.searchValue + "%'";
//		}
	}
...
//			this.orderString = " order by " + this.orderProperty + " ";
//			if(this.orderDirection != null){
//				this.orderString += this.orderDirection.toString();
//			}
//		}
	}
	...
	public void setFilters(List<Filter> filters) {
		...
		this.filtersString = getConditions(filters);
	}
