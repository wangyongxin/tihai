				...
				<form id="orderForm" action="create.jhtml" method="post">
					...
					<div class="span12 last">
						...
						<div class="total">
							...
							[/#if]
							<span[#if order.promotionDiscount == 0] class="hidden"[/#if]>${message("shop.order.promotionDiscount")}: <em id="promotionDiscount">${currency(order.promotionDiscount, true)}</em>&nbsp;</span>
							<span[#if order.couponDiscount == 0] class="hidden"[/#if]>${message("shop.order.couponDiscount")}: <em id="couponDiscount">${currency(order.couponDiscount, true)}</em>&nbsp;</span>
