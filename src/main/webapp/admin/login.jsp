...
<%@page import="com.tihai.common.Setting"%>
<%@page import="com.tihai.util.SettingUtils"%>
<%@page import="com.tihai.util.SpringUtils"%>
<%@page import="com.tihai.common.Setting.CaptchaType"%>
<%@page import="com.tihai.common.Setting.AccountLockType"%>
<%@page import="com.tihai.service.RSAService"%>
		...
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<div class="link">
					...
					<a href="http://www.fengsuixin.com"><%=SpringUtils.getMessage("admin.login.official")%></a> |
					<a href="http://bbs.fengsuixin.com"><%=SpringUtils.getMessage("admin.login.bbs")%></a> |
					<a href="http://www.fengsuixin.com/about.html"><%=SpringUtils.getMessage("admin.login.about")%></a> |
					<a href="http://www.fengsuixin.com/contact.html"><%=SpringUtils.getMessage("admin.login.contact")%></a> |
					<a href="http://www.fengsuixin.com/license.html"><%=SpringUtils.getMessage("admin.login.license")%></a>
				</div>
			</form>
		</div>
	<%} else {%>
